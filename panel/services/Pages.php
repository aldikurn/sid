...
$pages = array(
    ...
    new PageReferenceComposite('COVID19', 'nav-icon fas fa-virus',
        array(
            new PageReference('Pendataan', 'covid19/pendataan.php', 'fas fa-table nav-icon'),
            new PageReference('Pemantauan', 'covid19/pemantauan.php', 'fas fa-user-cog nav-icon')
        )
    ),
