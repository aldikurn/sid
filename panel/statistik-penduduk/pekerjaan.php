    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Statistik Pekerjaan Penduduk</h5>
...
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $index_location . '/services/HighCharts/getStatistikPekerjaan.php');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$data = curl_exec($ch);
curl_close($ch);
?>
<script>
    const pekerjaan = JSON.parse('<?= $data ?>');
